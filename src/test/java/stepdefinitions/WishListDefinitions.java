...
public class WishListDefinitions extends HooksDefinitions{
    ...
    public void user_add_first_product_to_wishlist() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//div[@class='buttons']/button[@onclick='return " +
                "AjaxCart.addproducttocart_catalog(\"/addproducttocart/catalog/26/2/1\"),!1']")).click();
        Thread.sleep(6000);

    }
    @And("user add second product to wishlist")
    public void user_add_second_product_to_wishlist() throws InterruptedException {
        driver.findElement(By.xpath("//div[@class='search-box store-search-box']" +
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//div[@class='buttons']/button[@onclick='return " +
                "AjaxCart.addproducttocart_catalog(\"/addproducttocart/catalog/18/2/1\"),!1']")).click();
        Thread.sleep(6500);
    ...
    public void user_can_add_products_to_wishlist() throws InterruptedException {
        driver.findElement(By.xpath("//div[@class='header-links']/ul/li/a[@href='/wishlist']")).click();
        Thread.sleep(3000);
